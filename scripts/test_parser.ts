...
const TESTS: TestCase[] = [
  ...
  { query: '隔离 485 全双工', expectedFeatures: ['隔离RS485', 'RS-485', '隔离', '全双工'], expectedMust: ['隔离RS485', '全双工', 'RS-485', '隔离'] },
  { query: '隔离CAN', expectedFeatures: ['隔离CAN', 'CAN-FD', '隔离'] },
  { query: '集成隔离电源的隔离CAN', expectedFeatures: ['集成隔离电源的隔离CAN', '隔离电源', 'CAN-FD', '隔离'], expectedMust: ['集成隔离电源的隔离CAN', '隔离电源', 'CAN-FD', '隔离'] },
  { query: '集成隔离电源的隔离RS485', expectedFeatures: ['集成隔离电源的隔离RS485', '隔离电源', 'RS-485', '隔离'], expectedMust: ['集成隔离电源的隔离RS485', '隔离电源', 'RS-485', '隔离'] },
  ...
  { query: 'I2C IO扩展', expectedFeatures: ['I2C', 'IO扩展器'], expectedMust: ['I2C', 'IO扩展器'] },
  ...
  { query: '隔离I2C', expectedFeatures: ['隔离I2C', 'I2C', '隔离'] },
  ...
  { query: '降压器', expectedFeatures: ['DCDC', '降压'], expectedMust: ['DCDC', '降压'] },
  { query: '升压器', expectedFeatures: ['DCDC', '升压'], expectedMust: ['DCDC', '升压'] },
  ...
  // ── Signal chain ──
  { query: '隔离运放', expectedFeatures: ['隔离放大器', '运放'] },
  { query: '隔离调制器', expectedFeatures: ['隔离放大器', '隔离'] },
  { query: '零漂运放', expectedFeatures: ['零漂运算放大器', '运放'] },
  { query: '高压运放', expectedFeatures: ['高压运算放大器', '运放'] },
  { query: '低压运放', expectedFeatures: ['低压运算放大器', '运放'] },
  { query: '放大器 推荐', expectedFeatures: ['放大器'], needsLLM: false },
  { query: '差动放大器 推荐', expectedFeatures: ['差动放大器', '放大器'] },
  { query: '对数放大器 推荐', expectedFeatures: ['对数放大器', '放大器'] },
  { query: '系统基础芯片 推荐', expectedFeatures: ['SBC'], needsLLM: false },
  ...
  { query: '运放 用于 温度传感器', expectedFeatures: ['运放', '温度传感器'] },

  // ── Switch / Mux ──
  { query: '模拟开关 8:1', expectedFeatures: ['模拟开关', '8:1'] },
  { query: '5口千兆交换机 非管理型', expectedFeatures: ['千兆', '交换机', '5口', '非管理型'] },
  ...
  { query: '隔离ADC', expectedFeatures: ['隔离ADC'], forbiddenFeatures: [] },
